...
###### old link_by_link definition ######

##def link_by_id(link_id):
##    for linked in links:
##        if linked.id == link_id:
##            return linked
...
new_link = Link(50, 62445, 1331234004, 49, "Something Something", "http://martingryner.com/developers-guide-to-garage48-hackatron/")
